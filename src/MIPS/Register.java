...
public class Register {
    ...
    public static Register $t0 = new Register("$t0", RegisterType.Global);
    public static Register $t1 = new Register("$t1", RegisterType.Global);
    public static Register $t2 = new Register("$t2", RegisterType.Global);
    public static Register $t3 = new Register("$t3", RegisterType.Global);
    public static Register $t4 = new Register("$t4", RegisterType.Global);
    public static Register $t5 = new Register("$t5", RegisterType.Global);
    public static Register $t6 = new Register("$t6", RegisterType.Global);
    public static Register $t7 = new Register("$t7", RegisterType.Global);
    public static Register $t8 = new Register("$t8", RegisterType.Global);
    public static Register $t9 = new Register("$t9", RegisterType.Global);
    ...
    public static Register $gp = new Register("$gp",RegisterType.Temp);
    public static Register $sp = new Register("$fp",RegisterType.Temp);
    ...
    public static int getGlobalAmount(){
        int result=0;
        for(Register reg:regs){
            if(reg.type==RegisterType.Global) result++;
        }
        return result;
    }
    public static List<Register> getGlobalRegs(){
        List<Register> result = new ArrayList();
        for(Register reg:regs){
            if(reg.type==RegisterType.Global) result.add(reg);
        }
        return result;
    }

    public static Register getTempRegister(int index){
        if(index==0) return $v1;
        else if(index==1) return $gp;
        else return $sp;
    }
    public static void assign(Value value){
        List<Register> globalRegs = getGlobalRegs();
        for(int i=0;i<globalRegs.size();i++){
            boolean flag=false;
            for(Value neighbour:value.crash){
                if(neighbour.registerAssigned==globalRegs.get(i)) {
                    flag=true;
                    break;
                }
            }
            if(!flag){
                value.registerAssigned=globalRegs.get(i);
                break;
            }
        }
    }
