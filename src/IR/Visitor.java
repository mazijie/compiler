                ...
                //printf
                {
                    ...
                    for(int i=0;i<str.length();i++){
                        if(str.charAt(i)=='%'&&str.charAt(i+1)=='d'){
                            ...
                            args.add(v);
//                            args.add(NewSymbolManager.searchByName(visitExp(stmt.exps.get(count)).name));
//                            args.add(IRBuildFactory.buildValue(visitExp(stmt.exps.get(count)).name,ValueType._i32));
